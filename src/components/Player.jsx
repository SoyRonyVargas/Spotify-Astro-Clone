...
export const CurrentSong = ({ image, title, artists }) => {
    ...
    return (
        <div className="flex items-center gap-3 relative">
            <picture className="w-16 h-16 bg-zinc-800 rounded-md shadow-lg ">
...
const SongControl = ({ audioRef }) => {
    ...
    const formatTime = time => {
        ...
        if( time == null || time === 0 || isNaN(duration) ) return '0:00'
    ...
    return (
        <div className="flex items-center gap-x-3 mt-3 text-xs">
...
export const VolumeControl = () => {
    ...
    const handleClickVolumePrevious = () => {
